...
class Dashboard(models.Model):
    ...
    total_rec = fields.Integer(string = "Total Rec.", compute = '_compute_rec' , store=True)

    # print("************************************************")
    # ************************* #
    def _compute_rec(self):
        x = self.env['hospital.patient'].search_count([])
        # print("************************",x,"************************")
        for rec in self:
            rec.total_rec = self.env['hospital.patient'].search_count([])
            # print("*******************",rec.total_rec)
    # ************************* #
