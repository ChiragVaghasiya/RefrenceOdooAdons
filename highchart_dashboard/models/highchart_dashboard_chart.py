...
class HighchartDashboardChart(models.Model):
    ...
    model_id = fields.Many2one('ir.model', 'Model', required=True,
                               domain="[('access_ids','!=',False),('transient','=',False),('model','not ilike','base_import%'),('model','not ilike','ir.%'),('model','not ilike','web_editor.%'),('model','not ilike','web_tour.%'),('model','!=','mail.thread'),('model','!=','highchart.dashboard'),('model','!=','highchart.dashboard.chart')]", ondelete='cascade')
    ...
    total_record = fields.Integer(string="Record Count", compute='_compute_total_record')
    ...
    second_total_record = fields.Integer("Record Count", compute='_compute_second_total_record')
