...
var HrDashboard = AbstractAction.extend({
    ...
    jsLibs: [
     ...
     events: {
             ...
             'click .hr_timesheets_manual': 'hr_timesheets',
             'click .hr_timesheets_manual_today': 'hr_timesheets_today',
             'click .hr_timesheets_manual_month': 'hr_timesheets_month',
            ...
            //  ******************   Add MANually ****************** //
             ...
             'click .table_data_candidates_activity': 'table_data_candidates_activity',
             'click .first_div_first_section_hr_personal_activity_boxes': 'first_div_first_section_hr_personal_activity_boxes',
    ...
    init: function(parent, context) {
        ...
        this.date_to = moment();
        this.dashboards_templates = ['LoginEmployeeDetails','HrDetails','ManagerDashboard', 'EmployeeDashboard','LoginEmployeeDetailsBackupes'];
    ...
    willStart: function(){
        ...
        .then(function() {
            var def0 =  self._rpc({
                ...
                // console.log('fjkadskafjksdhkjadsfksadhf',result)
                if (result == "main_hr"){
            ...
            var def1 =  self._rpc({
                ...
                // console.log("**************self.login_employee**************",self.login_employee);
    ...
    render_dashboards: function() {
        ...
        if (this.login_employee){
            ...
            // ====================== MANUAL ====================== //
            if( self.is_main_hr == true){
                templates = ['HrDetails'];
                // templates = ['HrDetails' , 'ManagerDashboard' , 'EmployeeDashboard'];
                // templates = ['LoginEmployeeDetails' , 'HrDetails' , 'ManagerDashboard' , 'EmployeeDashboard'];
            }
            else if( self.is_jr_hr == true){
                templates = ['HrDetails'];
                // templates = ['HrDetails' , 'ManagerDashboard' , 'EmployeeDashboard'];
                // templates = ['LoginEmployeeDetails' , 'HrDetails' , 'ManagerDashboard' , 'EmployeeDashboard'];
            }
                ...
                templates = [];
                // templates = ['ManagerDashboard' , 'EmployeeDashboard'];
            }   
...
//        today = mm + '/' + dd + '/' + yyyy;
    ...
    hr_timesheets_today: function(e) {
         var self = this;
        ...
        this.do_action({
            ...
            domain: [['employee_id','=', this.login_employee.id] , ['date','=', date]],
            target: 'current'
        }, options)
    },

    hr_timesheets_month: function(e) {
         var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        // console.log("****************",this.login_employee.display_name)
    },
    ...
    table_data_job_applications: function(e) {
       ...
       this.do_action({
        ...
        //    views: [[false, 'kanban'],[false, 'list'], [false, 'form']],
           context: {
            // 'search_default_user_id': self.login_employee.display_name
           },
        //    domain: [['user_id','=', this.login_employee.display_name] , ['stage_id','=',split_2[1]] ,['job_opening_id','=',split_2[0]]],
           domain: [ ['stage_id','=',split_2[1]] ,['job_opening_id','=',split_2[0]]],
           target: 'current'
        }, options)
        // console.log("*******this*********",this);
        // console.log("*******this.id*********",this.id);
        // console.log("*******e*********",e);
        // console.log("*******classes*********",split_2[0]);
        // console.log("*******e.target*********",e.currentTarget.className);
        // console.log("*******options*********",options);
        // console.log("*******this.login_employee.stage_id*********",this.login_employee.stage_id);
   },
       ...
       // first_div_first_section_hr_personal_activity_boxes

       first_div_first_section_hr_personal_activity_boxes: function(e) {
        var self = this;
        var class_name = e.currentTarget.className
        var split_1 = class_name.split(' first_div_first_section_hr_personal_activity_boxes')
        var date = new Date().toJSON();
       e.stopPropagation();
       e.preventDefault();
       var options = {
